...
object Strings {
    ...
    private val zh: Map<String, String> = mapOf(
        ...
        "group_subnet" to "按网段",
        "group_tag" to "按标签",
        "group_type_usb" to "USB",
        "group_type_wireless" to "无线",
        "group_type_unknown" to "未知类型",
        "group_status_online" to "在线",
        "group_status_offline" to "离线",
        "group_subnet_none" to "USB / 无 IP",
        "group_tag_none" to "未分组",
        "group_count" to "（%d）",
        "set_tag" to "设置标签",
        "tag_label" to "标签",
        ...
        "app_detail" to "应用详情",
        "export_apk" to "导出 APK",
        "export_apk_save_title" to "导出 APK",
        "export_apk_success" to "已导出至 %s",
        "export_apk_no_path" to "该应用无 APK 路径，无法导出",
        "permissions" to "权限",
        ...
        "export_progress" to "导出中(%d 行)",
        "logcat_empty_hint" to "看不到日志？某些设备（如 TCL 电视）出厂把 logd 设成静默。点此尝试修复。",
        "logcat_fix_button" to "修复 logcat",
        "logcat_fix_running" to "修复中…",
        "logcat_ring_cap" to "日志内存缓冲行数",
        "logcat_ring_cap_hint" to "内存环形缓冲上限（越大保留历史越多，占内存越多；重启生效）",
        "logcat_ring_cap_err" to "需为 1000–1000000",
        // System Ops
        "system_ops" to "系统操作",
...
用完点「全部移除」清理。""",
        ...
        "update_downloading_indeterminate" to "下载中…",
    ...
    private val en: Map<String, String> = mapOf(
        ...
        "group_none" to "None",
        "group_type" to "Type",
        "group_status" to "Status",
        "group_subnet" to "Subnet",
        "group_tag" to "Tag",
        "group_type_usb" to "USB",
        "group_type_wireless" to "Wireless",
        "group_type_unknown" to "Unknown",
        "group_status_online" to "Online",
        "group_status_offline" to "Offline",
        "group_subnet_none" to "USB / no IP",
        "group_tag_none" to "Untagged",
        "group_count" to " (%d)",
        "set_tag" to "Set tag",
        "tag_label" to "Tag",
        ...
        "version" to "Version",
        "abi" to "ABI",
        "code_path" to "Install dir",
        "apk_path" to "APK path",
        "native_libs" to "Native libs",
        "no_native_libs" to "No native libs",
        "app_detail" to "App detail",
        "export_apk" to "Export APK",
        "export_apk_save_title" to "Export APK",
        "export_apk_success" to "Exported to %s",
        "export_apk_no_path" to "This app has no APK path to export",
        "permissions" to "Permissions",
        "load_permissions" to "Load permissions",
        "loading" to "Loading…",
        "granted" to "Granted",
        ...
        "bugreport" to "Bugreport",
        "export_bugreport" to "Export Bugreport",
        "bugreport_pick_dir" to "Choose destination directory",
        ...
        "export_progress" to "Exporting (%d lines)",
        ...
        "logcat_ring_cap" to "Logcat in-memory buffer (lines)",
        "logcat_ring_cap_hint" to "Ring buffer cap (more = more scrollback history, more memory; restart to apply)",
        "logcat_ring_cap_err" to "Must be 1000–1000000",
        // System Ops
...
Click "Remove All" when done to clean up.""",
        ...
        "update_downloading_indeterminate" to "Downloading…",
